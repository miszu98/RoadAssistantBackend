...
import io.malek.roadassistantauthorization.user.register.DefaultUserCreationFacade;
import io.malek.roadassistantauthorization.user.register.User;
import io.malek.roadassistantauthorization.user.register.UserMapper;
import io.malek.roadassistantauthorization.user.register.UserRepository;
...
import static io.malek.roadassistantauthorization.user.register.UserCreationResponseAssert.*;
